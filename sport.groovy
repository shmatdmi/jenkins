pipeline {
    ...
    parameters {
        ...
        string(name: 'COUNT', defaultValue: '50', trim: true, description: 'Количество повторений')
        string(name: 'LOCATION', defaultValue: 'Кутуза', trim: true, description: 'Место выполнения упражнения')
