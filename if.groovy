    ...
    stages {
        stage ('if else') {
            ...
            steps {
                ...
                sh "rm ./data/*"
                sh "ls -la ./data"
                sh "curl -m 2 'https://app.openweathermap.org/data/2.5/weather?q=Moscow,RU&appid=ba23e3e7888484e7a26b57b215d65200&units=metric' >> ./data/${APPLICATION_NAME}-weather.json"
                sh "ls -la ./data"
